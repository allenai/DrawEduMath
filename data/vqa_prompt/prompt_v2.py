# Categorize Tiers + Extract Facets --> Generate QA Pairs
DECOMPOSE_PROMPT = """
    ...
    These atomic descriptions should be organized into different categories of Tier 0, Tier 1, Tier 2, and Tier 3,
    which have the following features: 
        Tier 0: The topics in this tier are about the quality or other generic features of the image such as background, 
    ...
    If there are no topics related to a tier, then return an empty string for that tier. Output your answer in JSON. 
    DONOT make any inferences about the math content.
    ...
    did a great job showing their work on this multi-step addition problem involving positive and negative integers. 
    They annotated their number line well and circled their final answer, 2, which is correct. Keep up the great work! '

    Generate:
    { 
    ‘Tier 0’: [
    ‘This is a natural image’, handwritten horizontal number line on lined paper.’,
            ],
    ‘Tier 1’: [
    ...
    ‘Tier 2’: [
        "The student's answer shows the summation of positive and negative integers 
    (-6, 12, -4) using a number line with even-numbered intervals.",
...
QA_PROMPT = """
    ...
    and a person should be able to answer the question using information from the description. For example, given 
    a list of these descriptions:
    {
        ...
        ‘Tier 3’: []}
Generate the question and answer pairs as:
{
    ...
    “Tier1”: [{"question": "What is drawn on the lined paper?",
        ...
        {"question": "Which integers are labeled on the number line from left to right?",
            ...
            "answer": "starts above 0 and ends above -6, starts above -6 and ends above 6,  
            starts above 6 and ends above 2."}],
    “Tier2”: [{"question": "What mathematical concept does the student's work illustrate?",
            "answer": "The student's work illustrates the summation of positive and negative 
            integers using a number line."},
            {"question": "How does the student use arrows to show their work?",
            "answer": "The arrows illustrate three summation steps: 0 + -6 = -6, -6 + 12 =  
            6, and 6 + -4 = 2."}],
    “Tier3”: []
}
